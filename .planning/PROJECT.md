...
**Shipped:** v1.6 Career Actions (2026-02-11)

v1.6 added personalized career actions generated by Claude Haiku 4.5 alongside opportunity matching. Users see 3-5 targeted actions (replicate papers, find collaborators, start orgs, etc.) as violet-accented cards on the matches page and dashboard. Full lifecycle: save, dismiss, in-progress, done. Completing actions feeds into the enrichment system via a pre-seeded chat, creating a virtuous profile-growth cycle.

## Current Milestone: v2.0 Course Program Platform

**Goal:** Build a course/program platform with unified prompts, AI learning partner, facilitator agent, and live session runner — meaningfully better than BlueDot Impact for BAISH's Technical AI Safety course.
...
**Active milestone:** v2.0 Course Program Platform

**Tech stack:** Convex + TanStack Start + React 19 + shadcn/ui + Claude Sonnet 4.5/Haiku 4.5

**Codebase:** ~120,000 lines TypeScript, ~500 files
...
<!-- Current scope: v2.0 Course Program Platform -->

- [ ] Unified prompt system (exercises, session activities, polls, feedback — one primitive)
- [ ] AI sidebar for participants (learning partner with module context + Socratic feedback)
- [ ] Facilitator agent with full program data access and propose-and-approve workflow
- [ ] Session runner with live phases, timers, pairing, and real-time responses
- [ ] Module enhancements (essential/optional materials, audio, time-to-session, continue-here)
...
**Current state:** v1.6 shipped 2026-02-11. Career actions complete with full lifecycle and enrichment loop. Platform is feature-rich for BAISH pilot.
...
_Last updated: 2026-03-10 after v2.0 milestone started_
