# Requirements Archive: v1.2 Org CRM & Events
...
- [x] **EVT-01**: Org admin can create events (title, description, date/time, location, capacity) — _via lu.ma integration_
...
- [x] **EVT-04**: User can RSVP to events (Going / Not Going) — _via lu.ma link-out_
...
All requirements delivered as specified. Event creation (EVT-01) and RSVP (EVT-04) satisfied via lu.ma integration rather than native implementation, as noted in requirements.
