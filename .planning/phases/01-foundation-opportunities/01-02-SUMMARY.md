...
# Tech tracking
tech-stack:
  added: [date-fns, shadcn/label, shadcn/textarea, shadcn/select, shadcn/checkbox]
  patterns: [convex-tanstack-query-mutations, admin-layout-pattern, reusable-form-pattern]
