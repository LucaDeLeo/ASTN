...
export type ExtractionState =
  | { status: "idle" }
  | { status: "extracting"; stage: ExtractionStage; documentId: Id<"uploadedDocuments"> }
...
export function useExtraction(): UseExtractionReturn {
  ...
  const extractFromDocument = useCallback(async (documentId: Id<"uploadedDocuments">) => {
  ...
  const extractFromText = useCallback(async (text: string) => {
    ...
    setState({ status: "extracting", stage: "extracting", documentId: "" as Id<"uploadedDocuments"> });
...
export type { ExtractionState, ExtractedData, ExtractionStage } from "./hooks/useExtraction";
```
  </action>
