...
--coral-500: oklch(0.7 0.16 30); /* Same as --primary */
--coral-600: oklch(0.6 0.14 30);
--coral-700: oklch(0.5 0.12 30);
--coral-800: oklch(0.4 0.1 30);
--coral-900: oklch(0.3 0.08 30);
```
...
- Tailwind utilities generated: font-display, font-body, bg-cream-_, text-coral-_, etc.
  </success_criteria>
