...
Output: Font preload links in __root.tsx, animation tokens and keyframes in CSS, reduced motion support.
</objective>
...
--ease-spring: cubic-bezier(0.34, 1.56, 0.64, 1);  /* Slight overshoot, organic settle */
...
--animate-slide-down: slide-down var(--duration-slow) var(--ease-spring) forwards;
...
6. Verify preload links appear in page source: View Source, search for "preload"
  ...
  <done>
- woff2 imports added to __root.tsx
