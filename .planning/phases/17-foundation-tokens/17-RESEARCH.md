...
/* Add to @theme */
--scale-press: 0.97;
--shadow-hover: 0 8px 30px oklch(0.70 0.08 30 / 0.15);
--shadow-press: 0 4px 15px oklch(0.70 0.06 30 / 0.10);
```
