...
must_haves:
  ...
  artifacts:
    - path: "src/styles/app.css"
      provides: "Warm shadow CSS custom properties"
...
<task type="auto">
  <name>Task 1: Add warm shadow tokens to CSS</name>
...
<task type="auto">
  <name>Task 2: Create GradientBg component</name>
...
<task type="auto">
  <name>Task 3: Update Card component with warm shadow</name>
