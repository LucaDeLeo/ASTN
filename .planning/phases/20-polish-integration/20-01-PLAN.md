...
2. Add ThemeToggle to the nav, before the NotificationBell:
   ...
   <verify>
3. `bun run dev` - app loads without hydration errors
4. Click theme toggle - switches between light/dark/system
5. Refresh page - theme persists
6. Hard refresh in dark mode - no flash of light theme
7. Set to System, change OS preference - app follows
   </verify>
