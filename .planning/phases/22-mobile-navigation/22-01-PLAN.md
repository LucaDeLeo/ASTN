...
Output: Updated __root.tsx with viewport-fit=cover, PWA manifest with proper name/short_name, and safe area CSS utilities ready for use by tab bar and layout components.
</objective>
...
3. Status bar that follows system theme automatically
  ...
  <done>__root.tsx contains viewport-fit=cover, apple-mobile-web-app-capable=yes, and apple-mobile-web-app-status-bar-style=default</done>
</task>
