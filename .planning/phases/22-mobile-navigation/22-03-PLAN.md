...
must_haves:
  truths:
    - "User can access Admin, Help (email support), and Logout via hamburger menu"
...
6. Structure:
   ...
   - Nav section with:
     ...
     - Help link (HelpCircle icon) - external mailto: link (href="mailto:support@aisafetytalent.org") using an anchor tag, not Link component. Opens email client for support.
...
2. Confirm Admin, Help (mailto link), Logout items are present with correct icons
