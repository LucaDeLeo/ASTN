...
must_haves:
  truths:
    ...
    - "Fonts load without flash of unstyled text (FOIT)"
  artifacts:
...
3. Check that headings appear in Space Grotesk (geometric, technical look vs Lora's serif)
4. Check the network tab - Space Grotesk woff2 should load
5. Run `bun run lint` - no TypeScript errors
  </verify>
  <done>
