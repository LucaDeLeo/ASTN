...
if (!toolUse) { /* existing error handling */ }
...
async function getPKCEData(): Promise<{
  ...
  return data as { codeVerifier: string; state: string; provider: "github" | "google" };
}
```
...
export const matchItemSchema = z.object({
  ...
  }).passthrough()).optional(), // Optional: LLM may omit
...
export const matchResultSchema = z.object({
  ...
  }).passthrough()).optional(), // Optional: LLM may omit in some batches
}).passthrough();
