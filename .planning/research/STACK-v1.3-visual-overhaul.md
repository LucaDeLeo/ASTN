...
@theme {
  ...
  --color-warm-400: oklch(0.7 0.015 30);
  ...
  --shadow-sm: 0 1px 2px oklch(0.7 0.04 30 / 0.08);
  --shadow-md: 0 4px 12px oklch(0.7 0.06 30 / 0.12);
  --shadow-lg: 0 8px 30px oklch(0.7 0.08 30 / 0.15);
  --shadow-xl: 0 16px 50px oklch(0.7 0.1 30 / 0.18);
  --shadow-glow: 0 0 30px oklch(0.7 0.16 30 / 0.25);
