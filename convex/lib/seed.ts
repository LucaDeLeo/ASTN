...
export const seedDevData = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    if (existingOrg) {
      return {
        success: false,
        message: "Database already has data. Run lib/seed:clearDevData first to reseed.",
      };
    }
    ...
    const baishId = await ctx.db.insert("organizations", {
      ...
      country: "Argentina",
      isGlobal: false,
      description: "The Buenos Aires hub for AI safety research, community events, and co-working.",
      memberCount: 45,
    ...
    const apartId = await ctx.db.insert("organizations", {
      ...
      isGlobal: false,
      description: "Collaborative AI safety research through hackathons, sprints, and fellowships.",
      memberCount: 120,
      hasCoworkingSpace: false,
      contactEmail: "team@apartresearch.com",
      website: "https://apartresearch.com",
      socialLinks: [{ platform: "twitter", url: "https://twitter.com/ApartResearch" }],
    });
    ...
    const profileData = [
      {
        ...
        workHistory: [
          ...
          },
          {
            ...
            current: false,
            description: "Worked on mechanistic interpretability of transformer models.",
          },
        ],
        skills: [
          "Interpretability",
        ...
        aiSafetyInterests: ["Mechanistic Interpretability", "Scalable Oversight"],
      ...
      },
      {
        ...
        skills: ["Machine Learning Engineering", "Deep Learning", "Python", "PyTorch", "RLHF"],
        careerGoals: "Transition from industry ML to technical AI safety research.",
      ...
      },
      {
        ...
        aiSafetyInterests: ["Scalable Oversight", "Alignment Research", "AI Safety Evaluation"],
      ...
      },
      {
        ...
        workHistory: [
          {
            ...
            current: true,
            description: "Developing adversarial evaluation frameworks for LLMs.",
          },
        ],
        skills: [
          "Red Teaming",
        ...
        careerGoals: "Build industry-standard red teaming tools for AI systems.",
      ...
      },
      {
        ...
        headline: "Formal methods researcher applying verification to neural networks",
        preferredLanguage: "en",
        education: [
          {
        ...
        careerGoals: "Pioneer practical formal safety guarantees for deployed AI systems.",
      ...
      },
      {
        ...
        careerGoals: "Help shape EU AI regulation to effectively address safety concerns.",
        aiSafetyInterests: ["AI Governance and Policy", "AI Ethics", "Existential Risk"],
      ...
      },
      {
        ...
        careerGoals: "Understand alignment well enough to contribute to technical research.",
      ...
      },
      {
        ...
        headline: "NLP researcher applying language models to safety evaluations",
        preferredLanguage: "en",
        education: [
          {
        ...
        workHistory: [
          {
            ...
            current: true,
            description: "Building evaluation pipelines for language model safety.",
          },
        ],
        skills: [
          "AI Safety Evaluation",
        ...
        careerGoals: "Develop comprehensive safety evaluation suites for frontier models.",
      ...
      },
      {
        ...
        skills: ["AI Ethics", "Existential Risk", "Research Communication", "Project Management"],
        careerGoals: "Scale AI safety education across Latin America.",
        aiSafetyInterests: ["AI Ethics", "Existential Risk", "AI Governance and Policy"],
    ...
    const membershipIds: Record<string, Id<"orgMemberships">> = {};
    ...
    const opps = [
      {
        ...
        extractedSkills: ["Alignment Research", "Deep Learning", "RLHF", "Interpretability"],
      ...
      },
      {
        ...
        extractedSkills: ["AI Governance and Policy", "Technology Policy", "Technical Writing"],
      ...
      },
      {
        ...
        requirements: ["Completed AGISF or equivalent", "Available for full-time participation"],
      ...
      },
      {
        ...
        extractedSkills: ["Interpretability", "Machine Learning Engineering", "PyTorch", "Python"],
      ...
      },
      {
        ...
        extractedSkills: ["Technical Writing", "Research Communication", "AI Ethics"],
        lastVerified: now - 86400000 * 2,
    ...
    const oppIds: Array<Id<"opportunities">> = [];
    ...
    const matchData = [
      ...
      },
      {
        ...
        status: "active" as const,
        explanation: {
          strengths: ["Strong interpretability background", "Former DeepMind intern"],
      ...
      },
      {
        ...
        explanation: {
          strengths: ["Currently doing AGISF", "Strong ML fundamentals", "Eager to transition"],
        },
        recommendations: [
          {
            type: "specific" as const,
    ...
    const pastEventId = await ctx.db.insert("events", {
      ...
      description: "Discussion of transformer circuits and feature visualization.",
    ...
    const careerActions = [
      ...
      },
      {
        ...
        profileBasis: ["skills:Interpretability", "org:BAISH", "colleague:user_seed_005"],
        status: "active" as const,
    ...
    await ctx.db.insert("opportunityApplications", {
      ...
      responses: {
        ...
        project: "Building an open-source toolkit for multilingual AI safety evaluation.",
        availability: "June 2026",
      },
      submittedAt: now - 86400000 * 5,
      reviewedAt: now - 86400000 * 1,
      reviewNotes: "Strong candidate — Anthropic background is excellent. Schedule interview.",
    });
    ...
    const engagementData = [
      {
        ...
        userExplanation: "You're a core part of the BAISH community! Keep up the great work.",
        signals: {
          eventsAttended90d: 8,
      ...
      },
      {
        ...
        orgId: baishId,
        level: "new" as const,
        adminExplanation: "Just joined a month ago, enrolled in AGISF. Early signals are positive.",
        userExplanation: "Welcome to BAISH! You're off to a good start with the reading group.",
        signals: {
          eventsAttended90d: 2,
          lastAttendedAt: now - 86400000 * 4,
          rsvpCount90d: 3,
    ...
    await ctx.db.insert("feedback", {
      featureRequests: "Would love to see a way to export my profile as a PDF for applications.",
      page: "/profile",
      userId: "user_seed_003",
      createdAt: now - 86400000 * 10,
    });
    ...
    await ctx.db.insert("feedback", {
      bugReports: "The coworking space calendar doesn't show weekends correctly.",
      page: "/spaces",
      userId: "user_seed_005",
      createdAt: now - 86400000 * 3,
    });
