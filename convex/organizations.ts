...
const AI_SAFETY_ORGANIZATIONS = [
  ...
  },
  {
    ...
    slug: 'openai',
    description:
      'AI research organization focused on ensuring artificial general intelligence benefits humanity.',
    city: 'San Francisco',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: 'deepmind',
    description:
      'AI research lab with dedicated safety teams working on alignment and interpretability.',
    city: 'London',
  ...
  },
  {
    ...
    description:
      'Nonprofit research organization focused on applied alignment research and interpretability.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: 'miri',
    description:
      'Research nonprofit focused on mathematical foundations of AI alignment.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    description:
      'Nonprofit focused on reducing societal-scale risks from AI through research and field-building.',
    city: 'San Francisco',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: 'ai-safety-camp',
    description:
      'Intensive research programs connecting aspiring researchers with AI safety mentors.',
    isGlobal: true,
  },
  {
    ...
    slug: 'beri',
    description:
      'Supports university research groups working on existential risk reduction.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: '80000-hours',
    description:
      'Career advice nonprofit helping people find high-impact careers, including AI safety.',
    city: 'London',
    country: 'United Kingdom',
    isGlobal: true,
  },
  {
    ...
    description:
      'Major funder of AI safety research and organizations globally.',
    city: 'San Francisco',
    country: 'United States',
    isGlobal: true,
  },
  {
    ...
    description:
      'Online community for AI alignment researchers to discuss technical research.',
    isGlobal: true,
  },
  {
    name: 'Conjecture',
    slug: 'conjecture',
    description:
      'AI safety company working on alignment research and safe AI development.',
    city: 'London',
    country: 'United Kingdom',
    isGlobal: false,
  },
  {
    ...
    slug: 'arc',
    description:
      'Nonprofit conducting AI alignment research and model evaluations.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: 'eleutherai',
    description:
      'Grassroots collective of researchers focused on open-source AI and interpretability.',
    isGlobal: true,
  },
  {
    name: 'FAR AI',
    slug: 'far-ai',
    description:
      'Research organization working on trustworthy AI through robustness and alignment.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    slug: 'chai',
    description:
      'UC Berkeley research center focused on developing provably beneficial AI systems.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
  {
    ...
    description:
      'Research organization focused on evaluating and detecting deceptive AI behavior.',
    city: 'London',
    country: 'United Kingdom',
    isGlobal: false,
  },
  {
    ...
    slug: 'metr',
    description:
      'Organization conducting evaluations of AI systems for dangerous capabilities.',
    city: 'Berkeley',
    country: 'United States',
    isGlobal: false,
  },
