...
export function ResumeExtractionReview({
  ...
  const { basicFields, educationItems, workHistoryItems, skillsItem } = useMemo(() => {
    ...
    return { basicFields: basic, educationItems: education, workHistoryItems: work, skillsItem: skills };
  }, [items]);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Skills Section */}
      {(skillsItem || (extractedData.rawSkills && extractedData.rawSkills.length > 0)) && (
        <section className="space-y-3">
                ...
                <div className="flex gap-1">
                  <Button
                    ...
                    className={cn(
                      ...
                      skillsItem.status === "accepted" && "text-green-600 bg-green-100"
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      skillsItem.status === "rejected" && "text-red-600 bg-red-100"
                    )}
                  >
                    <X className="size-4" />
                  </Button>
