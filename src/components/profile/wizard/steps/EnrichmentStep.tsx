  ...
  useEffect(() => {
    if (
      ...
      if (fromExtraction) {
        ...
        void sendMessage(
          'Hi! I just imported my resume. Can you help me complete my profile?',
        )
      } else if (chatFirst) {
        hasAutoGreeted.current = true
        // Chat-first: user starting from scratch, seed conversation with intent
        void sendMessage(
          "Hi! I'd like help creating my profile. I'm starting from scratch.",
        )
      }
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Have a conversation with our AI career coach to enhance your
            profile.
          </p>
        </div>
        {messages.length > 0 && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-700 mt-1">
                The extracted information has been added to your profile. You
                can continue the conversation to add more details.
              </p>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Start a new conversation if you would like to update your
