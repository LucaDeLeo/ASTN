...
export function NotificationPrefsForm() {
  ...
  const id = useId()
  const matchAlertsHelpId = `${id}-match-alerts-help`
  const weeklyDigestHelpId = `${id}-weekly-digest-help`
  const timezoneHelpId = `${id}-timezone-help`
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label
              htmlFor="match-alerts"
              className="flex items-center gap-2 text-base font-medium"
            >
              <Bell className="size-4 text-primary" />
              Match Alerts
            </Label>
            <p id={matchAlertsHelpId} className="text-sm text-slate-500">
          ...
          <Switch
            ...
            aria-describedby={matchAlertsHelpId}
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p id={weeklyDigestHelpId} className="text-sm text-slate-500">
        ...
        <div className="space-y-2">
          ...
          <p id={timezoneHelpId} className="text-sm text-slate-500 mb-2">
            We&apos;ll send notifications at appropriate times for your location
          </p>
          <Select value={timezone} onValueChange={handleTimezoneChange}>
            <SelectTrigger className="w-full" aria-describedby={timezoneHelpId}>
